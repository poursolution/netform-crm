...
(function(root){
 ...
 async function read(resource,args={}){
  ...
  if(resource==='operational'){
   ...
   return {contract_version:1,resource,coverage:'complete_for_actor_scope',scope:'actor_authorized_rows_only',data:{contract_version:4,deals,inquiries,expansion_pool}};
  }
