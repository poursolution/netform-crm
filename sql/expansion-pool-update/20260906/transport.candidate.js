...
(function(root){
 ...
 const rpcAllow=new Set(['crm_profile_scoped_v2','crm_read_scoped_v2','crm_contacts_scoped_v2','crm_write_command_v2','crm_operational_source_v1']);
 ...
 async function read(resource,args={}){
  ...
  if(resource==='operational'){
   ...
   return {contract_version:1,resource,coverage:'complete_for_actor_scope',scope:'actor_authorized_rows_only',data:{contract_version:5,deals,inquiries,expansion_pool,expansion_events:expansion_pool.flatMap(x=>Array.isArray(x.events)?x.events:[])}};
  }
