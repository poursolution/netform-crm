...
DO $production_guard$
BEGIN
 IF current_user<>'postgres' OR current_setting('crm.cutover_ref',true) IS DISTINCT FROM 'ymfbmpnizxvqsamnczow'
...
-- SOURCE sql/phase1/staging-apply.sql
SET crm.phase1_ref='ymfbmpnizxvqsamnczow';
...
DO $$ BEGIN
 IF current_user<>'postgres' OR current_setting('crm.phase1_ref',true) IS DISTINCT FROM 'ymfbmpnizxvqsamnczow'
...
-- SOURCE sql/work-compat/20260906/staging-apply.sql
SET crm.work_compat_ref='ymfbmpnizxvqsamnczow';
...
SET LOCAL statement_timeout='60s';
DO $$ BEGIN
 IF current_user<>'postgres' OR current_setting('crm.work_compat_ref',true) IS DISTINCT FROM 'ymfbmpnizxvqsamnczow'
...
-- SOURCE sql/inquiry-direct-assign/20260906/staging-apply.sql
SET crm.inquiry_direct_ref='ymfbmpnizxvqsamnczow';
...
SET LOCAL statement_timeout='60s';
DO $$ BEGIN
 IF current_user<>'postgres' OR current_setting('crm.inquiry_direct_ref',true) IS DISTINCT FROM 'ymfbmpnizxvqsamnczow'
...
-- SOURCE sql/operational-bundle/20260906/staging-apply.sql
SET crm.operational_bundle_ref='ymfbmpnizxvqsamnczow';
...
DO $$ BEGIN
 IF current_user<>'postgres'
  OR current_setting('crm.operational_bundle_ref',true) IS DISTINCT FROM 'ymfbmpnizxvqsamnczow'
...
-- SOURCE sql/operational-full-local-candidate/20260906/staging-apply.sql
-- LOCAL FULL OPERATIONS REVIEW CANDIDATE ONLY. Separate Staging approval is required.
-- Target: netform-crm-staging / ymfbmpnizxvqsamnczow. Production and n8n are forbidden.

SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='360s';
SET LOCAL crm.operational_full_local_ref='ymfbmpnizxvqsamnczow';

-- ===== APPLY operational_cutover =====
-- LOCAL CUMULATIVE REVIEW CANDIDATE ONLY. Separate Staging approval is required.
-- Target: netform-crm-staging / ymfbmpnizxvqsamnczow. Production and external workflow endpoints are forbidden.

SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='240s';
SET LOCAL crm.customer_asset_ref='ymfbmpnizxvqsamnczow';
-- ===== APPLY REACHABLE 21-OP BUNDLE =====
-- LOCAL REVIEW CANDIDATE ONLY. Staging execution requires separate explicit approval.
-- Target project: netform-crm-staging / ymfbmpnizxvqsamnczow. Production is forbidden.

SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='180s';
SET LOCAL crm.reachable_operations_bundle_ref='ymfbmpnizxvqsamnczow';

-- ===== APPLY personal_state =====
SET LOCAL crm.personal_state_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.personal_state_ref='ymfbmpnizxvqsamnczow';
...
SET LOCAL crm.pipeline_action_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.pipeline_action_ref='ymfbmpnizxvqsamnczow';
...
-- ===== APPLY quote_version =====
SET LOCAL crm.quote_version_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.quote_version_ref='ymfbmpnizxvqsamnczow';
...
SET LOCAL crm.operational_source_ref='ymfbmpnizxvqsamnczow';
...
-- ===== APPLY next_complete =====
SET LOCAL crm.next_complete_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.next_complete_ref='ymfbmpnizxvqsamnczow';
...
-- ===== APPLY stage_check =====
SET LOCAL crm.stage_check_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.stage_check_ref='ymfbmpnizxvqsamnczow';
...
-- ===== APPLY transition =====
SET LOCAL crm.transition_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.transition_ref='ymfbmpnizxvqsamnczow';
...
-- ===== APPLY close_nonwon =====
SET LOCAL crm.close_nonwon_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.close_nonwon_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.expected_amount_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.expected_amount_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.waiting_context_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.waiting_context_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_reclassify_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.inquiry_reclassify_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
-- ===== APPLY inquiry_hold =====
SET LOCAL crm.inquiry_hold_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.inquiry_hold_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_trash_restore_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.inquiry_trash_restore_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
-- ===== APPLY inquiry_purge =====
SET LOCAL crm.inquiry_purge_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.inquiry_purge_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_followup_ref='ymfbmpnizxvqsamnczow';
SET LOCAL crm.inquiry_followup_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.opportunity_create_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;SET LOCAL lock_timeout='3s';SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_response_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_pipeline_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_stage_progress_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.inquiry_action_check_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.technical_inquiry_transfer_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='60s';
...
SET LOCAL crm.attachment_compat_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
...
SET LOCAL crm.close_won_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.expansion_update_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.expansion_note_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.message_reminder_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.next_postpone_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.mobile_today_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.customer_support_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.message_log_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
SET LOCAL crm.relationship_cadence_ref='ymfbmpnizxvqsamnczow';
SET LOCAL search_path=pg_catalog;
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='90s';
...
-- SOURCE sql/operational-go-candidate/20260907/staging-apply.sql
...
SET LOCAL lock_timeout='3s';
SET LOCAL statement_timeout='180s';
SET LOCAL crm.operational_go_ref='ymfbmpnizxvqsamnczow';
