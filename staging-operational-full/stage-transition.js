...
(function(root){
 ...
 const definitions={
  ...
  rapport:{label:'유대관계 강화',fields:[f('reaction','고객 반응','text',true),f('likelihood','현재 진행 가능성','select',false,['높음','보통','낮음','미확인']),f('contact_date','다음 접촉일','date',true)]},
  silent:{label:'침묵관리',fields:[f('reason','침묵 사유','text',true),f('last_contact','마지막 유효접촉일','date'),f('contact_date','재접촉 예정일','date',true)]},
