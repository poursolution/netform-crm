...
(async()=>{
 ...
 try{
  ...
  await page.locator('#si-perf [data-si-action="person"][data-value="황윤선"]').first().click();assert.match(await page.locator('#si-person .contract-sales-panel').innerText(),/300,000,000원/);await page.keyboard.press('Escape');
