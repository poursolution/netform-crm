...
- **귀속 정책 대표 확정(2026-09-25)**: 브랜드 실적 = 최초 유입 브랜드(원천, 기술자문 전환 후에도 불변) · 담당자 실적 = 확정 시점 귀속 담당자 동결(예외는 관리자 정정 + 사유) · 둘은 섞지 않음 · 컷오프 없음 — 확정한 건부터 즉시 공식 합산, 미확정은 '검증 대기'로만 표시.
- 기술자문 직접영업 = 같은 현장에 다른 브랜드 영업 이력 없이 기술자문으로 바로 시작한 건만. 이력이 있으면 그 브랜드가 원천.
