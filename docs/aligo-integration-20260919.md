...
4. 새 서버 코드 병합과 실행기 활성화. Draft PR #87(https://github.com/poursolution/netform-crm/pull/87)에 코드 19개 파일을 올렸으며 최초 코드 커밋의 GitHub Quality Gate가 통과했다. 병합·자동발송 활성화는 아직 하지 않았다. 웹 프런트엔드에 비밀키를 포함하지 않는다.
