...
'use strict';
const colors=Object.freeze({consulting:'#2563eb',sent:'#0284c7',relationship:'#7c3aed',competition:'#ea580c',construction:'#16a34a',won:'#0f766e',lost:'#dc2626',expansion:'#64748b'});
const definitions=[
...
].map((d,i)=>Object.freeze({...d,color:colors[d.key],number:String(i+1).padStart(2,'0'),codes:Object.freeze(d.codes)}));
...
return {colors,definitions:Object.freeze(definitions),group,definition,rank,ordered};
});
