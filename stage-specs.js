...
const specs={
 ...
 construction:{purpose:'계약 확정과 인계·진행 확인',queueLayout:'work',priorityRule:['계약대기','계약완료','시공중','준공확인'],primaryAction:action('계약 확인','contract'),queueFields:['contractDate','contractAmount','salesOwner','startDate','currentStage'],detailHighlights:['contractState','contractDate','salesOwner','startDate'],sortField:'startDate'},
 won:{purpose:'계약과 현장 결과 확인',queueLayout:'result',priorityRule:['현재 수주 현장'],primaryAction:action('계약 결과','contract'),queueFields:['contractDate','contractAmount','salesOwner','completionDate'],detailHighlights:['contractState','contractDate','salesOwner','completionDate'],sortField:'contractDate',descending:true,summaryMetrics:'contract-ledger'},
