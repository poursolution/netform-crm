/* PC-only derived transport. Keep aligned with transport.js; tested for exact two-RPC extension. */
(function(root){
 'use strict';
 ...
 const rpcAllow=new Set(['crm_manager_request_create_v1','crm_manager_request_list_v1','crm_profile_scoped_v2','crm_read_scoped_v2','crm_contacts_scoped_v2','crm_write_command_v2','crm_operational_source_v1','crm_expansion_note','crm_expansion_context']);
