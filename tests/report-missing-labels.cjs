...
const host={};Object.assign(c,{undatedWonNoticeHTML:()=>'', $:()=>host,dashboardInquiryScope:()=>[],dashboardSnapshotDeals:()=>[],wonInPeriod:()=>[known,missing],inPeriod:()=>true,inquiryDate:()=>'',dealStage:d=>d.code,liveActs:()=>[],periodLabel:()=> '검증기간',eok:n=>n+'원',inqMadeStats:()=>({_made:0,_n:0}),pctOf:()=>0});
