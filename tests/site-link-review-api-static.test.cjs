...
const ui=fs.readFileSync(path.join(__dirname,'../pc-organization-history.js'),'utf8');
assert.match(ui,/String\(ack\.organization_id\)===String\(row\.organization_id\)/);
assert.match(ui,/ack\.resolution===resolution/);
