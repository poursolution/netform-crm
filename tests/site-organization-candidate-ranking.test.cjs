...
assert.doesNotMatch(sql,/insert into crm_security\.site_identity_links/);assert.doesNotMatch(sql,/update public\./);assert.match(ui,/\[1,2\]\.includes\(data\?\.contract_version\)/);
